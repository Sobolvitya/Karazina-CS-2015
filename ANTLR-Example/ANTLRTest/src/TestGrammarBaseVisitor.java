...
public class TestGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements TestGrammarVisitor<T> {
	 ...
	 */
	@Override public T visitInit(@NotNull TestGrammarParser.InitContext ctx) { return visitChildren(ctx); }
	 ...
	 * {@link #visitChildren} on {@code ctx}.
	 */
	@Override public T visitValue(@NotNull TestGrammarParser.ValueContext ctx) { return visitChildren(ctx); }
}